function [sat_detect, code_phase_aq, f_doppler, peak_value] = acquisition(fs, fi, prn, T, fid, T_off )
...
peak_threshold  = 1000000; % should be changed as fs changes or input signal power changes
